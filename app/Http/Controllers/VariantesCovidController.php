...
class VariantesCovidController extends Controller
{
    ...
    public function edit($id){
        ...
        //fin regresa un registro si lo encuentra
        //si no lo encuentra, regresa null
        if($variante !=NULL) {
            //me lleva al form edicion 
    ...
    public function update(Request $request, $id) {
        ...
        if($variante){
            ...
            return redirect()->route('variantes.edit', $id)->with('error','Variant was updated');
